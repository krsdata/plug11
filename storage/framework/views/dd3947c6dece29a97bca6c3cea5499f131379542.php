      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true" style="height: 499px;">
          <div class="col-md-12 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="<?php echo e(url('/')); ?>">Home </a> | About Us</h1>
            
            <form action="https://sportsfight.in/public/upload/apk/sportsfight.apk" class="search-location">
	        		<div class="row">
	        			<div class="col-lg align-items-end">
	        		<input type="image" src="<?php echo e(url('webmedia/images/download-android-new.png')); ?>" alt="About Us" align="center" style="height: 60px; margin-top: -30px">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sportsfight.in/resources/views/aboutus.blade.php ENDPATH**/ ?>