  ...
  <div class="row">
                  ...
                  <div class="caption">
                   ...
                   <div class="col-md-12 pull-right">
                      ...
                      <!--  <button type="button" class="btn pull-right btn-primary" data-toggle="modal" data-target="#getOldMatch" data-whatever="@" style="margin-right: 10px">Get Old Match</button> -->
                       <a href="<?php echo e(url('admin/oldMatch')); ?>">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat2 bordered">
              <div class="display">
                  <div class="number">
                      <h3 class="font-purple-soft">
                          <span data-counter="counterup" data-value="276"><?php echo e($total_flash_match); ?></span>
                      </h3>
              ...
              <div class="progress-info">
                  <div class="progress">
                      <span style="width: <?php echo e($total_flash_match); ?>%;" class="progress-bar progress-bar-success purple-soft">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat2 bordered">
              <div class="display">
                  <div class="number">
                      <h3 class="font-blue-sharp">
                          <span data-counter="counterup" data-value="567"><?php echo e($total_live_match); ?></span>
                      </h3>
              ...
              <div class="progress-info">
                  <div class="progress">
                      <span style="width: <?php echo e($total_live_match); ?>%;" class="progress-bar progress-bar-success blue-sharp">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat2 bordered">
              <div class="display">
                  <div class="number">
                      <h3 class="font-blue-sharp">
                          <span data-counter="counterup" data-value="567"><?php echo e($total_completed_match); ?></span>
                      </h3>
              ...
              <div class="progress-info">
                  <div class="progress">
                      <span style="width: <?php echo e($total_completed_match); ?>%;" class="progress-bar progress-bar-success blue-sharp">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat2 bordered">
              <div class="display">
                  <div class="number">
                      <h3 class="font-blue-sharp">
                          <span data-counter="counterup" data-value="567"><?php echo e($total_upcoming_match); ?></span>
                      </h3>
              ...
              <div class="progress-info">
                  <div class="progress">
                      <span style="width: <?php echo e($total_upcoming_match); ?>%;" class="progress-bar progress-bar-success blue-sharp">
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567"><?php echo e($total_cancel_match??0); ?></span>
                                        </h3>
                                ...
                                <div class="progress-info">
                                    <div class="progress">
                                        <span style="width: <?php echo e($total_cancel_match??0); ?>%;" class="progress-bar progress-bar-success blue-sharp">
      ...
      <div class="modal-body">
        <form action="<?php echo e(url('admin/saveMatchFromApi')); ?>">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control s_date" id="start_date" value="<?php echo e(date('Y-m-d')); ?>" readonly name="date_start">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label" >End Date:</label>
            <input type="text" class="form-control e_date" id="end_date" value="<?php echo e(date('Y-m-d')); ?>" readonly name="date_end">
          </div> 
...
<div class="modal fade" id="upload_match" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form method="POST" action="<?php echo e(url('admin/flashMatch')); ?>" accept-charset="UTF-8" class="" id="users_form" enctype="multipart/form-data">  
        <?php echo csrf_field(); ?> 
           <div class="form-group">
...
</div><?php /**PATH /var/www/sportsfight.in/modules/Admin/views/flashMatch/home.blade.php ENDPATH**/ ?>