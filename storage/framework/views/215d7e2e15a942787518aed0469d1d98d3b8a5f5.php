 <!-- END SIDEBAR -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567"><?php echo e($contest_types or 0); ?></span>
                                        </h3>
                                ...
                                <div class="progress-info">
                                    <div class="progress">
                                        <span style="width: <?php echo e($contest_types); ?>%;" class="progress-bar progress-bar-success blue-sharp">
                                            <span class="sr-only"><?php echo e($contest_types); ?>% grow</span>
                                        </span>
                                    </div>
                          ...
                          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567"><?php echo e($banner or 0); ?></span>
                                        </h3>
                                        <small> Banners </small>
                                    </div>
                                    <div class="icon">
                                ...
                                <div class="progress-info">
                                    <div class="progress">
                                        <span style="width: <?php echo e($banner); ?>%;" class="progress-bar progress-bar-success blue-sharp">
                                            <span class="sr-only"><?php echo e($banner); ?>% grow</span>
                                        </span>
                                    </div>
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567"><?php echo e($match_2); ?></span>
                                        </h3>
                                ...
                                <div class="progress-info">
                                    <div class="progress">
                                        <span style="width: <?php echo e($match_2); ?>%;" class="progress-bar progress-bar-success blue-sharp">
                                            <span class="sr-only"><?php echo e($match_2); ?>% grow</span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <a href="<?php echo e(url('api/v2/getMatchDataFromApiAdmin')); ?>" target="_blank">All Match Status  </a>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    ...
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <a href="<?php echo e(url('api/v2/updateMatchDataByStatusAdmin/3')); ?>">Live Match Status  </a>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    ...
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <a href="<?php echo e(url('api/v2/updateMatchDataByStatusAdmin/2')); ?>">Completed Match   </a>
                            ...
                            <div class="dashboard-stat2 bordered">
                                <div class="display">
                                    ...
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="567">
                                                <a href="<?php echo e(url('api/v2/updateMatchDataByStatusAdmin/1')); ?>" >Upcoming Match   </a>
        ...
        <?php /**PATH /var/www/sportsfight.in/modules/Admin/views/dashboard/home.blade.php ENDPATH**/ ?>